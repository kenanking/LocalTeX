...
Depends: libc6 (>= 2.39), libgcc-s1, libstdc++6, libegl1, libgbm1, libpipewire-0.3-0t64, libxkbcommon0, libxkbcommon-x11-0, libxcb1, libxcb-xkb1, libvulkan1, libx11-6, libfontconfig1
